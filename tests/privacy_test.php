...
use \theme_ledor\privacy\provider;

/**
 * Unit tests for theme_ledor/classes/privacy/policy
 *
 * @copyright  2018 Adrian Greeve <adriangreeve.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_ledor_privacy_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        $exportedpreferences = $writer->get_user_preferences('theme_ledor');
        $this->assertCount(1, (array) $exportedpreferences);
        $this->assertEquals('false', $exportedpreferences->{provider::DRAWER_OPEN_NAV}->value);
        $this->assertEquals(get_string('privacy:drawernavclosed', 'theme_ledor'),
        ...
        $this->assertEquals(get_string('privacy:drawernavopen', 'theme_ledor'),
                $exportedpreferences->{provider::DRAWER_OPEN_NAV}->description);
    }
}
