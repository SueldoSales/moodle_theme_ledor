...
/**
 * This file contains the unittests for ledor's scss compilation.
 *
 * @package   theme_ledor
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_ledor_scss_testcase extends advanced_testcase {
    /**
     * Test that ledor can be compiled using SassC (the defacto implemention).
     */
    public function test_scss_compilation_with_sassc() {
        ...
        $this->assertNotEmpty(
            theme_config::load('ledor')->get_css_content_debug('scss', null, null)
        );
    }
}
